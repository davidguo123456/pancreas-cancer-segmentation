...
class nnUNetLogger(object):
    ...
    def plot_progress_png(self, output_folder):
        ...
        ax.plot(x_values, self.my_fantastic_logging['train_class_losses'][:epoch + 1], color='b', ls='dotted', label="class_loss_tr", linewidth=4)
        ax.plot(x_values, self.my_fantastic_logging['val_losses'][:epoch + 1], color='r', ls='-', label="loss_val", linewidth=4)
        ax.plot(x_values, self.my_fantastic_logging['val_class_losses'][:epoch + 1], color='r', ls='dotted', label="class_loss_val", linewidth=4)
